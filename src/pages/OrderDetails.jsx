  ...
  return (
    <div>
      ...
      <div className="order-details">
        ...
        {/* Live Chat Button */}
        <button onClick={() => window.location.href = 'http://localhost:3002'}>Live Chat</button>
        
        {/* GPS Button */}
        <button onClick={() => window.location.href = `http://localhost:3003/?origin=${order?.restaurantLocation}&destination=${order?.clientLocation}`}>GPS</button>
      </div>
    </div>
  );
};
